...
def create_email_branding_pool(non_standard_values=None):
    ...
    return {'email_branding_pool': branding_pool}


@pytest.fixture(scope='function')
def mock_get_email_branding_pool(mocker):
    def _get_email_branding_pool():
        return create_email_branding_pool()

    return mocker.patch(
        'app.organisation_client.get_email_branding_pool', side_effect=_get_email_branding_pool
    )
